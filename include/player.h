...
#include "bullet.h" // Necessário para interagir com o sistema de projéteis
#include "hud.h"    // Necessário para interagir com a interface do usuário (ex: barra de energia)
