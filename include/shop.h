...
#include "player.h"     // Necessário para acessar e modificar o estado do jogador
#include "star.h"       // Necessário para desenhar e atualizar o campo estelar de fundo
#include "game_state.h" // Necessário para transição de estados (e.g., sair da loja)
