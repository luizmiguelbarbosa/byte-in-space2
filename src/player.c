...
#define SHURIKEN_SPRITE_PATH "assets/images/sprites/byte_2.png"         // Sprite com power-up de Double Shot
#define SHIELD_SPRITE_PATH "assets/images/sprites/byte_shield.png"     // Sprite com power-up de Escudo
#define EXTRA_LIFE_SPRITE_PATH "assets/images/sprites/byte_4.png"      // Sprite de Vida Extra (Removido, mas mantido)
